...
raw_file = Path("data/raw/census_occupations_nc_2022.json")
...
output_csv = processed_dir / "occupations_preview.csv"
output_json = processed_dir / "occupations_preview.json"
